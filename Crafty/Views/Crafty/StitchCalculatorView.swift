...
struct StitchCalculatorView: View {
            ...
            Form {
                Section{
                    VStack(alignment: .leading) {
                        TextField("Current stitch count", text: $currentStitchCount)
                    ...
                    VStack(alignment: .leading) {
                        TextField("Desired stitch count", text: $desiredStitchCount)
                            .keyboardType(.numberPad)
                ...
                if showResults {
                    ...
                    Section(header: Text("Instructions - Knitting in the Round")) {
    ...
    private func calculate() {
        guard let current = Int(currentStitchCount),
              let desired = Int(desiredStitchCount) else {
            errorMessage = "Please enter valid positive numbers"
            showResults = false
            return
        }
        
        let result = StitchCalculator.calculateInstructions(currentCount: current, desiredCount: desired)
